...
## 8. ESCRIBIR UNA FUNCION QUE CALCULE EL DESVIO ESTANDAR DE UNA 
# COLUMNA CUANTITATIVA DEL DATASET. COMPARAR EL RESULTADO CON LA
# FUNCION sd()

## 9. ESCRIBIR UNA FUNCION QUE CALCULE EL COEFICIENTE DE VARIACION 
# DE UNA COLUMNA CUANTITATIVA DEL DATASET. PISTA: SE PUEDE USAR ALGUNA
# DE LAS FUNCIONES GENERADAS MAS ARRIBA


## 10. LOS EXAMENES DE UNA MATERIA SE DISTRIBUYEN DE FORMA
...
## 11. SUPONGA QUE HAY UN EXMAEN EN EL QUE HAY 20 PREGUNTAS DE 
...
## 12. COMPRUEBE LA LEY DE LOS GRANDES NUMEROS
