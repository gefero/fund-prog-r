...
#5. GENERAR UNA FUNCION QUE CALCULE EL DESVIO STANDARD DE UNA 
# COLUMNA CUANTITATIVA DEL DATASET. COMPARAR EL RESULTADO 
# CON LA FUNCION sd() 
...
#6. GENERAR UNA FUNCION QUE CALCULE EL COEFICIENTE DE VARIACION
...
#7. LOS EXAMENES DE UNA MATERIA SE DISTRIBUYEN DE FORMA
...
#8. SUPONGA QUE HAY UN EXMAEN EN EL QUE HAY 20 PREGUNTAS DE 
...
#9. COMPRUEBE LA LEY DE LOS GRANDES NUMEROS
